...
This project is submitted to fulfill requirements for the first project in the [Udacity Full Stack Web Developer Nanodegree](https://www.udacity.com/course/full-stack-web-developer-nanodegree--nd0044). Please see below for the original project instructions.
