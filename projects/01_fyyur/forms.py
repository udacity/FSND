...
def phone_number(form, field):
    try:
        ...
        raise ValidationError('Invalid Phone Number, format must be xxx.xxx.xxxx, xxxxxxxxxx, or xxx-xxx-xxxx')
...
class VenueForm(Form):
    ...
    phone = StringField(
        'phone', validators=[phone_number, Optional()]
    )
