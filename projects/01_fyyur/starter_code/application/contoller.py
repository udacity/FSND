...
def venues():
  ...
  for venue in areas:
    print(venue)
    venue = dict(zip(('city', 'state'), venue)) # {city : venue.city, state : venue.state} mapping city and state to city and state val from venue data
    print(venue)
    venue['venues'] = [] #array of venues
    print(venue)
...
def show_artist(artist_id):
  ...
  data = {
    ...
    "state": artist.state,
    "phone": artist.phone,
    "website": "https://www.gunsnpetalsband.com", #TODO: add website field to artist data model
