...
def venues():
    ...
    states = Venue.query.with_entities(Venue.city, Venue.state).distinct(Venue.state).all()
...
def create_venue_submission():
    ...
    venue = Venue(
        ...
        phone=phone, image_link=image_link, facebook_link=facebook_link, website_link=website_link
    )
