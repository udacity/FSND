...
def show_venue(venue_id):
  ...
  shows = Show.query.filter_by(venue_id = venue_id).order_by('date_time').all()
  upcoming_shows = []
  past_shows = []
...
def show_artist(artist_id):
  ...
  shows = Show.query.filter_by(artist_id = artist_id).order_by('date_time').all()
  upcoming_shows = []
  past_shows = []
...
def edit_venue_submission(venue_id):
  try:
    ...
    venue.talent_wanted = True if form.talent_wanted.data == 'Yes' else False
    venue.talent_desc = form.talent_desc.data
    ...
    db.session.rollback()
    flash('An error occurred. Venue ' + request.form['name'] + ' could not be updated. ' + str(error))
  except:
    db.session.rollback()
...
def shows():
  ...
  shows = Show.query.order_by('date_time').all()
  data = []
