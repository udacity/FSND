...
def show_venue(venue_id):
  ...
  for show in venue.shows:
    artist_of_show = Artist.query.filter_by(id=show.artist_id).first()
    show_data = {
      'artist_id': show.artist_id,
      'artist_name': artist_of_show.name,
      'artist_image_link': artist_of_show.image_link,
...
def shows():
  ...
  # show has an attribute artist which is the reference to the artist itself. no need for join.
  data = []
